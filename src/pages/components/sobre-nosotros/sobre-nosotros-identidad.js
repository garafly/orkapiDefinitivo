...
import "./sobre-nosotros-identidad.css"


export default function IdentidadCorporativa() {
  return (

<div className="corpIdentity" id="mision">

    <div className="section1CorpI">
        <div className="textContentCorpI">
            <h3 ><span className="darkOrange">Misión</span></h3>
    ...
    <div className="section2CorpI">
        <div className="textContentCorpI">
            <h3><span className="darkOrange">Visión</span></h3>
    ...
    <div className="section1CorpI">
        <div className="textContentCorpI">
            <h3><span className="darkOrange">Valores</span></h3>
